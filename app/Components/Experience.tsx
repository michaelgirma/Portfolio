            ...
            <div id="ExperienceContainer">
                ...
                <div id="ExperienceTextContainer">
                    <p id="CurrentText">While I may not have professional experience in this field yet, I am a passionate self-learner and have dedicated numerous hours to mastering my skills in full stack web development. 
                        ...
                        I've put this knowledge to practice by building a projects which will be down below.  My journey has not only allowed me to apply and deepen my understanding but also created a strong sense of problem-solving, adaptability, and persistence. 
                        I've also had the opportunity to work on group projects and participate in coding challenges that have strengthened my team-work and time-management skills. 
